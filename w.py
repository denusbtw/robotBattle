...
# Map: 0 = hole
MAP = [
    [36, 36, 36, 36, 0, 36, 36, 36, 36, 36, 36, 36, 36, 36, 0, 36, 36, 36],
    [36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 0, 36, 36, 36, 36, 36, 36],
    [0, 36, 0, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36],
    [36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 0, 36, 36, 0, 36, 36],
    [36, 36, 36, 36, 0, 36, 36, 36, 36, 36, 36, 36, 0, 0, 36, 36, 36, 36],
    [36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36],
    [36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36],
    [36, 0, 36, 36, 36, 36, 36, 36, 0, 36, 36, 36, 36, 0, 36, 36, 0, 36],
    [36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36, 36],
    [36, 36, 36, 36, 36, 36, 36, 36, 36, 0, 36, 36, 36, 36, 36, 36, 36, 36],
...
def draw_grid(screen, tiles):
    """Draw the grid using sprite sheet frames indexed by MAP."""
    for row in range(GRID_ROWS):
        for col in range(GRID_COLS):
            frame_index = MAP[row][col]
            rect = pygame.Rect(col * CELL_SIZE, row * CELL_SIZE, CELL_SIZE, CELL_SIZE)
            if frame_index < len(tiles):  # Ensure index is within bounds
                screen.blit(tiles[frame_index], rect)
...
def load_sprite_sheet(image_path, frame_width, frame_height):
    """Load and slice the sprite sheet into tiles."""
...
def main():
    ...
    pygame.display.set_caption("Turn-Based Grid Movement with Sprite Sheet")
    clock = pygame.time.Clock()

    # Load the sprite sheet
    tiles = load_sprite_sheet("assets/tiles.png", CELL_SIZE, CELL_SIZE)
    ...
    while running:
        ...
        # Draw everything
        draw_grid(screen, tiles)  # Draw the grid using the tiles
        draw_exit(screen)
